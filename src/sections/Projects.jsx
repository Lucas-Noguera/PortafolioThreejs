    ...
    return (
        <section className="c-space my-20">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className="flex flex-col justify-between h-full relative sm:p-10 py-10 px-5 shadow-2xl shadow-block-200">
                    ...
                    <div className='flex flex-col gap-5 text-white-600 my-5'>
                        <p className='text-white text-2xl font-semibold animatedtText'>
